...
public class WorkRequestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button internetButton = findViewById(R.id.toggle_intenet_button);
        ...
        internetButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (WorkRequestService.isConnection) {
                    WorkRequestService.isConnection = false;
                    Toast.makeText(getApplicationContext(), "Интернет выключен", Toast.LENGTH_LONG).show();
                } else {
                    WorkRequestService.isConnection = true;
                    Toast.makeText(getApplicationContext(), "Интернет включён", Toast.LENGTH_LONG).show();
                }
